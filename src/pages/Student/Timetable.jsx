    ...
    const renderCalendar = () => {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            const validClassesForDate = potentialClasses.filter(cls => {
                ...
                // Problem: new Date("YYYY-MM-DD") can cause timezone errors.
                // Solution: Manually parse the date string to create a date object
                // in the user's local timezone, which prevents off-by-one day errors.
                ...
                // Set time to the end of the day to make the comparison inclusive.
                // This means if a class ends today, it will still show today.
                endDate.setHours(23, 59, 59, 999);
                
                // The current calendar `date` is already a local date object.
                return date <= endDate;
            });
            // --- END OF FIX ---
    ...
    return (
        <div className="content-card" style={styles.container}>
            <div style={styles.header}>
                <h3 style={styles.headerTitle}>Class Timetable</h3>
